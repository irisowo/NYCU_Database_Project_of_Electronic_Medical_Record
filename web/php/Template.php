  ...
  while (($line = fgetcsv($f)) !== false) {
    ...
    <td>
      <form target='_blank' method='post' action='search_result.php' class='tm-signup-form row'>
        ...
        <input id='neighbor_num' name='neighbor_num' type='hidden' value = $knum class='form-control validate' required pattern=[0-9][0-9][0-9] min='1' max='100'  oninput='this.setCustomValidity('')' ><br>
